      ...
      <div className="flex justify-end mb-4">
        <div className="inline-flex rounded-md shadow-sm">
          <button
            ...
            className={`px-3 py-1 text-sm font-medium ${chartType === 'bar' ? 'text-white' : 'bg-white text-gray-700 hover:bg-gray-50'} rounded-l-md border border-gray-300 focus:z-10 focus:ring-2 focus:ring-[var(--color-secondary)]`}
            style={{ backgroundColor: chartType === 'bar' ? 'var(--color-secondary)' : undefined }}
          >
            Bar
          </button>
          <button
            onClick={() => setChartType('radar')}
            className={`px-3 py-1 text-sm font-medium ${chartType === 'radar' ? 'text-white' : 'bg-white text-gray-700 hover:bg-gray-50'} rounded-r-md border-t border-b border-r border-gray-300 focus:z-10 focus:ring-2 focus:ring-[var(--color-secondary)]`}
            style={{ backgroundColor: chartType === 'radar' ? 'var(--color-secondary)' : undefined }}
          >
            Radar
          </button>
        </div>
